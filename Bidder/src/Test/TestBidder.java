...
public class TestBidder {
	...
	static BigInteger g, n; //pailier public key
	...
	System.out.println("pailier g = "+g);
	n = bClient.ReceiveBigInteger();
	System.out.println("pailier n = "+n);
	}
	
	private static void encryptPrice() throws Exception {
	paillier = new Paillier();
	
	ePrice = paillier.Encryption(price, g, n);
	System.out.println("ePkPrice = "+ePrice);
	}
